...
const CharactersPaginados: NextPage<{ page: number }> = (props: { page: number; }) => {
    const [characters, setCharacters] = useState<CharactersAPI | undefined>(undefined)

    const fetchCharacters = async () => {
        const res = await fetch(`https://rickandmortyapi.com/api/character?page=${props.page}`)
        const data = await res.json();
        
        console.log("Data characters/[page]: ", data)
